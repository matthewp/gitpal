...
This async support makes BobaUI suitable for real-world applications that need to perform network requests, file operations, or other I/O without freezing the interface.
