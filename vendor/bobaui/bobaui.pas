...
begin
  ...
  begin
    ...
    begin
      ...
      // Only clear to end of line if new line is shorter than old line
      if (I < Length(FLastRender)) and (Length(Line) < Length(FLastRender[I])) then
        ClearToEndOfLine;
    end;
  end;
...
var
  TickCmdFunc: function(I: integer): TMsg; cdecl;
begin
